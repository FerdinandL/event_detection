...
public:
  ...
  virtual void    glTransform(float dataLevel=WORLD_ZOOM_LEVEL, const QPointF &translation=QPointF(0,0)) = 0;
...
public:
  ...
  QVector3DD getEye() const;
  QVector3DD getLookAt() const;
...
inline QVector3DD Camera3D::getLookAt() const
{
  return this->pLookAt;
}

inline QVector3DD Camera3D::getEye() const
{
  return this->pEye;
}
